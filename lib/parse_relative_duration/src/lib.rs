...
//! assert_eq!(parse("1 day -1 hour"), Ok(RelativeDuration::from(Duration::new(82_800, 0))));
//! // Using exponents
//! assert_eq!(parse("1.26e-1 days"), Ok(RelativeDuration::from(Duration::new(10_886, 400_000_000))));
//! // Extra things will be ignored
//! assert_eq!(
//!     parse("Duration: 1 hour, 15 minutes and 29 seconds"),
//!     Ok(RelativeDuration::from(Duration::new(4529, 0)))
//! );
//! ```
//!
//! # Syntax
...
//!     Ok(RelativeDuration::from(Duration::new(1_296_020, 100_000_000)))
//! );
//! assert_eq!(
...
//! );
//!
//! assert_eq!(parse(".:++++]][][[][15[]][seconds][]:}}}}"), Ok(RelativeDuration::from(Duration::new(15, 0))));
//!
//! assert_eq!(parse("14 days seconds"), Ok(RelativeDuration::from(Duration::new(1_209_600, 0))));
//!
//! assert_eq!(parse(".:++++]][][[][15[]][][]:}}}}"), Ok(RelativeDuration::from(Duration::new(15, 0))));
//!
//! assert_eq!(parse("10 seconds 20 seconds"), Ok(RelativeDuration::from(Duration::new(30, 0))));
//! ```
//!
//! # Units
//!
...
//! assert_eq!(parse("10 days 1 nanoseconds 15 years"), Ok(RelativeDuration::years(15) + RelativeDuration::from(Duration::new(864_000, 1))));
//! // or very short names
//! assert_eq!(parse("10d1n15y"), Ok(RelativeDuration::years(15) + RelativeDuration::from(Duration::new(864_000, 1))));
//! ```
//!
//! # Values
//!
...
//! assert_eq!(parse("1 day -1 hour"), Ok(RelativeDuration::from(Duration::new(82_800, 0))));
//!
//! assert_eq!(parse("1.84467e10 seconds"), Ok(RelativeDuration::from(Duration::new(18_446_700_000, 0))));
//! ```
//!
//! # Errors
//!
