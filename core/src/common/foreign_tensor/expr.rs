...
impl From<InternalTensorSymbol> for TensorValue {
  fn from(value: InternalTensorSymbol) -> Self {
    Self {
...
impl From<InternalTensorSymbol> for TensorExpr {
  fn from(sym: InternalTensorSymbol) -> Self {
    Self::Symbol(sym)
  }
}
