...
pub struct DiffMaxMultProbContext<T: Clone, P: PointerFamily> {
  pub warned_disjunction: bool,
  pub valid_threshold: f64,
  pub storage: P::Pointer<Vec<T>>,
}

impl<T: Clone, P: PointerFamily> Clone for DiffMaxMultProbContext<T, P> {
  fn clone(&self) -> Self {
    Self {
...
impl<T: Clone + 'static, P: PointerFamily> DiffMaxMultProbContext<T, P> {
...
impl<T: Clone, P: PointerFamily> Default for DiffMaxMultProbContext<T, P> {
  fn default() -> Self {
    Self {
...
impl<T: Clone + 'static, P: PointerFamily> Provenance for DiffMaxMultProbContext<T, P> {
