...
pub struct DiffNandMultProbProvenance<T: FromTensor, P: PointerFamily> {
  pub valid_threshold: f64,
  pub storage: P::RcCell<Vec<T>>,
}

impl<T: FromTensor, P: PointerFamily> Clone for DiffNandMultProbProvenance<T, P> {
  fn clone(&self) -> Self {
    Self {
...
impl<T: FromTensor, P: PointerFamily> DiffNandMultProbProvenance<T, P> {
...
impl<T: FromTensor, P: PointerFamily> Default for DiffNandMultProbProvenance<T, P> {
  fn default() -> Self {
    Self {
...
impl<T: FromTensor, P: PointerFamily> Provenance for DiffNandMultProbProvenance<T, P> {
