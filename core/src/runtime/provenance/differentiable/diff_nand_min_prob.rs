...
pub struct DiffNandMinProbProvenance<T: FromTensor, P: PointerFamily> {
  pub valid_threshold: f64,
  pub storage: P::RcCell<Vec<T>>,
}

impl<T: FromTensor, P: PointerFamily> Clone for DiffNandMinProbProvenance<T, P> {
  fn clone(&self) -> Self {
    Self {
...
impl<T: FromTensor, P: PointerFamily> DiffNandMinProbProvenance<T, P> {
...
impl<T: FromTensor, P: PointerFamily> Default for DiffNandMinProbProvenance<T, P> {
  fn default() -> Self {
    Self {
...
impl<T: FromTensor, P: PointerFamily> Provenance for DiffNandMinProbProvenance<T, P> {
