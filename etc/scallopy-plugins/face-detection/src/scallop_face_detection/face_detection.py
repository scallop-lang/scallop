...
from . import ScallopFaceDetectionPlugin
...
def get_face_detection(plugin: ScallopFaceDetectionPlugin):
  ...
  def save_temporary_image(img_id, i, kind, img_tensor):
      ...
      directory = os.path.join(plugin, f"{img_id}")
