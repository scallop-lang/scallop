...
class MNISTSum2Net(nn.Module):
  def __init__(self, provenance, k):
    ...
    self.scl_ctx.add_rule("mult_2(a * b) = digit_1(a), digit_2(b)")

    # The `mult_2` logical reasoning module
    self.mult_2 = self.scl_ctx.forward_function("mult_2", [(i,) for i in range(82)])
  ...
  def forward(self, x: Tuple[torch.Tensor, torch.Tensor]):
    ...
    # Then execute the reasoning module; the result is a size 82 tensor
    return self.mult_2(digit_1=a_distrs, digit_2=b_distrs)
